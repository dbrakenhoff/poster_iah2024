...
\newcommand{\colorTitle}{0047ab}            % title block main color, cobalt
\newcommand{\colorTitleGradient}{0047ab}    % title block gradient color, cobalt
...
\newcommand{\colorBlockTitle}{95c8e8}       % color of block title
\newcommand{\colorBlock}{EEEEEE}            % color of blocks
% \newcommand{\colorBlockTitleText}{062C30}   % color of block title text
...
\begin{minipage}[c][][t]{175mm}
    ...
    \hfill
    \includesvg[width=80mm]{logo_tud.svg}
\end{minipage}
\hfill
